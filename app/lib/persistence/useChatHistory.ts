...
export const db = persistenceEnabled ? await openDatabase() : false;
            ...
            if (startingIdx > 0) {
              ...
              filteredMessages = [
                ...
                },
                {
                  ...
                  content: `Wider ml Restored your chat from a snapshot. You can revert this message to load the full chat history.
